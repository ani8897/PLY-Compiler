...
set_act_rec = "\t# setting up activation record for called function" 
...
li = "\tli $%s, %d"
la = "\tla $%s, global_%s"
lw_glob = "\tlw $%s, global_%s"
lw = "\tlw $%s, %d($%s)"
sw_glob = "\tsw $%s, %s"
sw = "\tsw $%s, %d($%s)"
move = "\tmove $%s, $%s"

move_from_v1 = "\tmove $%s, $v1 # using the return value of called function"
move_to_v1 = "\tmove $v1, $%s # move return value to $v1"
...
sp_add = "\tadd $sp, $sp, %d # destroying activation record of called function"
sp_sub =  "\tsub $sp, $sp, %d"
